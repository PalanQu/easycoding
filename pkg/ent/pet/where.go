...
func Type(v int8) predicate.Pet {
	return predicate.Pet(func(s *sql.Selector) {
...
func TypeEQ(v int8) predicate.Pet {
	return predicate.Pet(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldType), v))
	})
}
...
func TypeNEQ(v int8) predicate.Pet {
	return predicate.Pet(func(s *sql.Selector) {
...
func TypeIn(vs ...int8) predicate.Pet {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TypeNotIn(vs ...int8) predicate.Pet {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func TypeGT(v int8) predicate.Pet {
	return predicate.Pet(func(s *sql.Selector) {
...
func TypeGTE(v int8) predicate.Pet {
	return predicate.Pet(func(s *sql.Selector) {
...
func TypeLT(v int8) predicate.Pet {
	return predicate.Pet(func(s *sql.Selector) {
...
func TypeLTE(v int8) predicate.Pet {
	return predicate.Pet(func(s *sql.Selector) {
